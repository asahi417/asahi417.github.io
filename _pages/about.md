...
As part of my research activity, I create web services hosting the models analyzed/proposed in my study ([***T-NER***](https://asahiushio.com/projects/tner), [***AutoQG***](https://asahiushio.com/projects/autoqg)).
Those apps are all developed by my own (infrastructure, backend, frontend, etc). Finally, aside from NLP, I spend some time on the research of **computational art** ([***WikiART Face***](https://asahi417.github.io/projects/wikiart_face/)).
Also, I love prototyping my ideas as open-source software. Please have a look my [project page](https://asahiushio.com/projects) or [github](https://github.com/asahi417) to check my fun works!
